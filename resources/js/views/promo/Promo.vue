            ...
            <div class="wrap-table-kelola">
                <div class="mb-4">
                    <div class="d-flex justify-content-between align-items-center mb-5">
                        <p class="mb-0 font-weight-bold" style="color: darkslateblue">Promo</p>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center px-3 py-2 mb-1 block-list-item border-bottom">
                                                ...
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <div class="d-flex flex-wrap justify-content-start align-items-center">
                                                        <div style="width: 150px">
                                                            <p v-if="item.min_subtotal" class="mb-0" style="font-size: 9pt; color: black; font-family: sans-serif">Min subtotal: {{item.min_subtotal | toCurrency}} </p>
                                                            <p v-else class="mb-0" style="font-size: 9pt; color: black; font-family: sans-serif">-</p>
                                                        </div>
                                                        <div style="width: 150px;">
                                                            <p v-if="item.min_qty" class="mb-0" style="font-size: 9pt; color: black; font-family: sans-serif;">Min qty: {{item.min_qty}} x</p>
                                                            <p v-else class="mb-0" style="font-size: 9pt; color: black; font-family: sans-serif;">-</p>
                                                        </div>
                                                        <div style="width: 150px">
                                                            <p class="mb-0" style="font-size: 9pt; color: black; font-family: sans-serif">{{item.diskon}}%</p>
                                                        </div>
                                                        <div v-if="item.status == 'aktif'" style="width: 150px">
                                                            <div class="px-4 py-1 d-flex justify-content-center">
                                                                <p class="mb-0 font-weight-bold" style="color: rgb(141,215,204); font-size: 9pt">Aktif</p>
                                                            </div>
                                                        </div>
                                                        <div v-else style="width: 150px">
                                                            <div class="px-4 py-1 d-flex justify-content-center">
                                                                <p class="mb-0 font-weight-bold" style="color: rgb(255,160,135); font-size: 9pt">Tidak Aktif</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="d-flex justify-content-between align-items-center" style="width: 15%">
                                            ...
                                            <b-modal style="width: 200px" :id="'modal-no-backdrop-' + item.id" hide-backdrop hide-header hide-footer hide-header-close centered content-class="shadow" size="sm">
                                                <div>
                                                    <p class="font-weight-bold" style="font-size: 9pt">Hapus promo?</p>
                                                    <div class="d-flex justify-content-start align-items-center">
...
import Create from "../../components/promo/Create";
import Update from "../../components/promo/Update";
    ...
    methods: {
        ...
        async filterFunction(){
            const search = this.pre_items.filter(i => {
                return (
                i.min_subtotal != null ? i.min_subtotal.toString().indexOf(this.search) >= 0 : false ||
                i.min_qty != null ? i.min_qty.toString().indexOf(this.search) >= 0 : false ||
                i.status.toString().indexOf(this.search) >= 0 ||
                i.diskon.toString().indexOf(this.search) >= 0
                )
            })
            this.items = search
        },
        ...
        async redirectEdit(id){
            try{
                await this.$store.dispatch('promo/GET_INFO_BY_ID', id)
        ...
        async softDelete(item){
            try{
                await this.$store.dispatch('promo/SOFTDELETE_ONE', item)
        ...
        async exportPdf(){
            try {
                ...
                var columns = [
                { dataKey: 'min_subtotal', title: 'Min subtotal'},
                { dataKey: 'min_qty', title: 'Min qty'},
                { dataKey: 'diskon', title: 'Diskon'},
                ...
                doc.setFontSize(11);
                doc.text('Daftar Promo Laundry', 40, 120);
                ...
                doc.save('daftar-promo-laundry-' + this.outlet.nama + '.pdf');
