<template>
    <div>
        <b-modal id="modalCreate" title="Form paket baru" size="lg" :hide-footer="true" centered>
...
export default {
    ...
    methods:{
        ...
        async create(){
            ...
            try{
                await this.$store.dispatch('paket/CREATE', this.form)
                this.dismissCountDown = this.dismissSecs
                this.form.nama_paket = ''
                this.form.jenis = ''
                this.form.lama_pengerjaan = ''
                this.form.harga = ''
                await this.$v.$reset()
            }catch(err){
                alert(err);
